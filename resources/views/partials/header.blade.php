...
<head>
  ...
  <meta name="description" content="BigData">
  <meta name="keywords" content="BigData"/>
  <meta name="author" content="BigData">
  <meta name="csrf-token" content="{{ csrf_token() }}">

  <title>{{config('app.name', 'BigData') }} | @yield('title')</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="{{ url('/') }}" class="logo">
        ...
        <span class="logo-mini"><strong style="color:#fff">BigData</strong></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-sm"><strong style="color:#fff">BigData</strong></span>
      </a>
