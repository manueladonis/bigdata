    ...
    <div class="panel-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                    ...
                    <tr class="odd gradeX">
                        <td>{{ $key + 1 }}</td>
                        @if($userDatas->profile_image)
                        <td class="center">
                            <img src="{{ asset('storage/'.$userDatas->profile_image) }}" alt="Avatar" style="width:60px; height:60px; border-radius:50%">
                        </td>
                        @else
                        <td>
                            ...
                            <div class="modal fade" id="{{ $userDatas->id }}">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Are you sure you want to delete User with name? <h9 style="color: blue;">{{ $userDatas->first_name }} {{ $userDatas->last_name }}</h9>
                                        </div>
